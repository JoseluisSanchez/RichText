...
#Command SET DEFAULT <x> TO <y> => <x> := IIF( HB_ISNIL( <x> ), <x> := <y>, <x> )
...
CLASS RichText
	...
	METHOD New( cFileName, aFontData, nFontSize, nScale, aTrans ) 
...
SET DEFAULT cFileName TO "REPORT.RTF"
SET DEFAULT aFontData TO { "Courier New Cyr" }
SET DEFAULT nFontSize TO 12
SET DEFAULT	nScale TO INCH_TO_TWIP
...
SET DEFAULT lLandscape TO .F.
SET DEFAULT lNoWidow TO .F.
SET DEFAULT lPgNumTop TO .F.
...
*
*********************************************************************
SET DEFAULT lDefault TO .F.
SET DEFAULT lNoWidow TO .F.
SET DEFAULT lBreak TO .F.
SET DEFAULT lBullet TO .F.
SET DEFAULT lHang TO .F.
SET DEFAULT cAppear TO ""
SET DEFAULT cHorzAlign TO ""
SET DEFAULT cBulletChar TO "\bullet"
SET DEFAULT lNoPar TO .F.
...
*********************************************************************
LOCAL i
SET DEFAULT cTblHAlign TO "CENTER"
SET DEFAULT nTblFntNum TO 1
SET DEFAULT nTblFntSize TO ::nFontSize
SET DEFAULT nTblRows TO 1
SET DEFAULT nTblColumns TO 1
SET DEFAULT nTblRHgt TO NIL
SET DEFAULT aTableCWid TO ARRAY(nTblColumns) // see below
SET DEFAULT cRowBorder TO "NONE"
SET DEFAULT cCellBorder TO "SINGLE"
SET DEFAULT nCellPct TO 0
SET DEFAULT lTblNoSplit TO .F.
SET DEFAULT nTblHdRows TO 0
SET DEFAULT nTblHdHgt TO nTblRHgt
SET DEFAULT nTblHdPct TO .1
SET DEFAULT nTblHdFont TO nTblFntNum
SET DEFAULT nTblHdFSize TO ::nFontSize + 2
...
ELSEIF HB_IsLogical( xVal )	
	cRet := IIF( xVal, '.T.', '.F.' )
ELSEIF HB_IsMemo( xVal )	
	cRet := xVal
ELSEIF HB_IsHash( xVal )	
	cRet := "{ Hash of " +  LTrim( Str( Len( xVal ) ) ) + " Items }"
ELSEIF HB_IsArray( xVal )	
	cRet := "{ Array of " +  LTrim( Str( Len( xVal ) ) ) + " Items }"
ELSEIF HB_IsObject( xVal )	
	cRet := "{ " + xVal:ClassName() + " Object }"
ELSEIF HB_IsNIL( xVal )	
    cRet := "NIL"
ELSEIF HB_IsNull( xVal )	
    cRet := "Null"
ELSE
	cRet:= "Type: " + ValType( xVal )
ENDIF
RETURN cRet
